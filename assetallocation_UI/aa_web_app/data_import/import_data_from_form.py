...
class TimesInputs:
    ...
    def inputs_times_model(self) -> Times:
        ...
        t = Times(day_of_week=int(self.form.week_day.data), frequency=self.form.frequency.data,
                  ...
                  long_signals=[Decimal(i.data) for i in (self.form.sig1_long, self.form.sig2_long, self.form.sig3_long)],
                  short_signals=[Decimal(i.data) for i in (self.form.sig1_short, self.form.sig2_short, self.form.sig3_short)],
