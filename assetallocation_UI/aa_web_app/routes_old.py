...
from assetallocation_UI import app
from assetallocation_UI import InputsTimesModel, SideBarDataForm
from assetallocation_UI import InputsEffectStrategy
from assetallocation_UI import TimesChartsDataComputations
from assetallocation_UI import run_times_charts_data_computations

from assetallocation_UI import ReceivedDataTimes
from assetallocation_UI import ProcessDataEffect
from assetallocation_UI import DownloadDataChartEffect
...
@app.route('/')
def home():
    return render_template('home_old.html', title='HomePage')
