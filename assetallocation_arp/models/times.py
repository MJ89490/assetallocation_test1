...
import data_etl.get_data as gd
import models.portfolio_construction as pc
import models.arp as arp

file_path = r'H:\assetallocation_arp\assetallocation_arp\data_etl\matlabData.mat'

# load data and inputs
times_inputs = gd.data_frame_from_xlsx(r'H:\assetallocation_arp\assetallocation_arp\data_etl\ARP_Model_Inputs.xlsx', 'rng_times_inputs', 1)
asset_inputs = gd.data_frame_from_xlsx(r'H:\assetallocation_arp\assetallocation_arp\data_etl\ARP_Model_Inputs.xlsx', 'rng_times_assets', 1)
...
# calculate signals
signals = arp.momentum(times_data, times_inputs)
