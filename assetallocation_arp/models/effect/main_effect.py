...
def run_effect():
    ...
    obj_import_data = CurrencyComputations(start_date_calculations='2006-09-14')
    ...
    inflation_differential = \
        obj_inflation_differential.inflation_differential_computations(start_date_computations=
