...
class ComputeWarningFlagsOverview(ProcessDataEffect):
    ...
    def compute_warning_flags_rates(self):
        ...
        three_month_implied_usd_latest_date = self.three_month_implied_usd.loc[self.latest_date]
        ...
        three_month_implied_eur_latest_date = self.three_month_implied_eur.loc[self.latest_date]
