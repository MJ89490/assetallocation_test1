...
def create_list_names_all_currencies(assets_inputs):
    obj_import_data_times = ProcessDataEffect()
    config_data = obj_import_data_times.parse_data_excel_effect(assets_inputs)
    ...
    return CURRENCIES_SPOT, CURRENCIES_CARRY, CURRENCIES_IMPLIED, CURRENCIES_USD, CURRENCIES_EUR
