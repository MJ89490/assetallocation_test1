...
begin
	...
	insert into config.model_instance (business_daterange, model_id, python_code_version, execution_state_id)
	values (business_daterange, model_id, python_code_version, execution_state_id)
